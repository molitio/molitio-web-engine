var BSN = (function (H) {
    ...
    var Kc = (H, it, ct) =>
        it in H ? Vc(H, it, { enumerable: !0, configurable: !0, writable: !0, value: ct }) : (H[it] = ct);
    ...
    function Wi(t) {
        ...
        if (n && o) {
            ...
            if (a && a.length && [Je, ts].includes(s)) {
                let l = a.indexOf(o);
                o === e ? (l = 0) : s === ts ? (l = l > 1 ? l - 1 : 0) : s === Je && (l = l < a.length - 1 ? l + 1 : l),
                    a[l] && ht(a[l]);
            }
        ...
        show() {
            ...
            if (!n) {
                ...
                a && a.hide(),
                    ...
                    w(i, ms),
                    ms.defaultPrevented ||
                        (f(o, m), f(i, m), O(e, ct, 'true'), Pn(this), (this.open = !n), ht(e), Dn(this), w(i, Cn));
            }
        }
        hide() {
            const { element: e, open: n, menu: o, parentElement: i } = this;
    ...
    class ee extends st {
        ...
        show() {
            ...
            if (
                !h(e, m) &&
                ((Ve.relatedTarget = o || void 0), (eo.relatedTarget = o || void 0), w(e, Ve), !Ve.defaultPrevented)
            ) {
                const c = Mt(e);
                if (c && c !== e) {
                    const a = me(c) || F(c, bs);
    ...
    const _t = 'popover',
        ...
        dc = (t) => {
            ...
            if (S) {
                ...
                s
                    ? i && j && Ct(j, i, g)
                    : (i && lt && Ct(lt, X, g), v && j && Ct(j, q, g), (t.btn = D('.btn-close', S) || void 0)),
                    f(S, 'position-fixed'),
        ...
        hc = (t) => {
            ...
            return (
                e.find((o, i) =>
                    z(o, 'position') !== 'relative' && e.slice(i + 1).every((c) => z(c, 'position') === 'static')
                        ? o
                        : null,
                ) || E(t).body
            );

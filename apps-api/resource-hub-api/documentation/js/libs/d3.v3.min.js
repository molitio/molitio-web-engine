...
!(function () {
    ...
    function ee(n) {
        ...
        function r(t) {
            ...
            function u(e, r) {
                var u = vt([e, r]),
                    o = n(e, r);
                i(x, M, m, _, b, w, (x = o[0]), (M = o[1]), (m = e), (_ = u[0]), (b = u[1]), (w = u[2]), a, t),
                    t.point(x, M);
            }
            function o() {
                (S.point = e), t.lineEnd();
    ...
    function He(n) {
        ...
        if ((Ja.insert(t, l), t || e)) {
            if (t === e)
                return (
                    Be(t), (e = je(t.site)), Ja.insert(l, e), (l.edge = e.edge = Ke(t.site, l.site)), $e(t), void $e(e)
                );
            if (e) {
                Be(t), Be(e);
                var c = t.site,
    ...
    function Hi(n, t) {
        var e,
            ...
            o = n[i];
        return (
            o < u && ((e = r), (r = i), (i = e), (e = u), (u = o), (o = e)), (n[r] = t.floor(u)), (n[i] = t.ceil(o)), n
        );
    }
    function Oi(n) {
        return n
        ...
        (to.layout.force = function () {
            ...
            return (
                (l.tick = function () {
                    ...
                    if (g)
                        for (ei((t = to.geom.quadtree(x)), i, a), r = -1; ++r < b; ) (l = x[r]).fixed || t.visit(n(l));
                    for (r = -1; ++r < b; )
                        (l = x[r]).fixed
                            ? ((l.x = l.px), (l.y = l.py))
                    ...
                    if (h < Lo) {
                        var D = null == S ? [b, w] : null == M ? [m, x] : Re([m, x], [S, k], [M, _], [b, w]),
                            ...
                            H =
                                1 /
                                Math.sin(
                                    Math.acos((P * U + j * F) / (Math.sqrt(P * P + j * j) * Math.sqrt(U * U + F * F))) /
                                        2,
                                ),

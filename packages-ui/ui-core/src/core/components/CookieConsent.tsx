...
const CookieConsent: React.FC = () => {
    ...
    const [cookieAcceptAdvertisementButtonState, setCookieAcceptAdvertisementButtonState] = useState<"yes" | "no">("no");
    return (
        <>
                ...
                <div className="space-y-7">
                    <div className="grid grid-cols-[1fr_auto] justify-between text-white">
                        ...
                        <div className="flex space-x-5">
                            <button className={`rounded p-1 px-2 hover:bg-gray-500 ${cookieAcceptAllButtonState === "yes" ? "bg-gray-500" : ""}`} onClick={() => setCookieAcceptAllButtonState("yes")}>Yes</button>
                            <button className={`rounded p-1 px-2 hover:bg-gray-500 ${cookieAcceptAllButtonState === "no" ? "bg-gray-500" : ""}`} onClick={() => setCookieAcceptAllButtonState("no")}>No</button>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-[1fr_auto] justify-between text-white">
                        ...
                        <div className="flex space-x-5">
                            <button className={`rounded p-1 px-2 hover:bg-gray-500 ${cookieAcceptAdvertisementButtonState === "yes" ? "bg-gray-500" : ""}`} onClick={() => setCookieAcceptAdvertisementButtonState("yes")}>Yes</button>
                            <button className={`rounded p-1 px-2 hover:bg-gray-500 ${cookieAcceptAdvertisementButtonState === "no" ? "bg-gray-500" : ""}`} onClick={() => setCookieAcceptAdvertisementButtonState("no")}>No</button>
                        </div>
                    </div>

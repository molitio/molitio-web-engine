...
export interface FileRouteTypes {
    ...
    fullPaths: '/' | '/$locale' | '/$locale/about' | '/$locale/contact' | '/$locale/';
    fileRoutesByTo: FileRoutesByTo;
    to: '/' | '/$locale/about' | '/$locale/contact' | '/$locale';
    id: '__root__' | '/' | '/$locale' | '/$locale/about' | '/$locale/contact' | '/$locale/';
...
const LocaleRouteWithChildren = LocaleRoute._addFileChildren(LocaleRouteChildren);

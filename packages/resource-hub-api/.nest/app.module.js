...
const _loggermiddleware = require("./logger/logger.middleware");
const _userpublicmodule = require("./user-public/user-public.module");
...
AppModule = _ts_decorate([
    (0, _common.Module)({
        imports: [
            ...
            _userpublicmodule.UserPublicModule
        ],
        controllers: [

...
const AboutCover: React.FC = () => {
    ...
    return (
        <StyledAboutCover>
            ...
            />
            <StyledCoverContent>
                <StyledAboutMainTitle>{useLineBreakParser(aboutCoverTextContent?.title ?? '')}</StyledAboutMainTitle>
                <StyledAboutSubTitle>{useLineBreakParser(aboutCoverTextContent?.subTitle ?? '')}</StyledAboutSubTitle>
                <StyledAboutDescription>

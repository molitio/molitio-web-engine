...
export const StyledServicesContentMainTitle = styled.h1`
    ...
    text-shadow: ${(props) => props?.theme?.palette?.visual['servicesTextShadow']?.textShadow ?? ''};
...
export const StyledServicesContentPanelImageWaterSplash = styled(StyledWaterSplash)`
    right: -80px;
    bottom: -110px;

...
const BrandMessage: React.FC = () => {
    ...
    return (
        <StyledBrandMessage>
            ...
            <StyledBrandMessageMainTitle>{textContent?.title ?? ''}</StyledBrandMessageMainTitle>
            ...
            <StyledBrandMessagePanel>
                ...
                <StyledBrandMessagePanelContent>
                    <StyledBrandMessagePanelTitle>{textContent?.contentTitle ?? ''}</StyledBrandMessagePanelTitle>

                    <StyledBrandMessagePanelText>{textContent?.contentText ?? ''}</StyledBrandMessagePanelText>

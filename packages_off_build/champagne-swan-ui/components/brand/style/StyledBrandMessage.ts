...
export const StyledBrandMessageOfficeCleanerImage = styled.img`
    ...
    border-radius: 1em;
    box-shadow: ${(props) => props?.theme?.palette?.visual['brandMessageOfficeCleaners']?.boxShadow ?? ''};
`;
...
export const StyledBrandMessageMainTitle = styled.h1`
    ...
    text-shadow: ${(props) => props?.theme?.palette?.visual['brandMessageTitleShadow']?.textShadow ?? ''};
...
export const StyledBrandMessagePanelTitle = styled.h1`
    ...
    color: ${(props) => props?.theme?.palette?.text?.primary ?? ''};
    text-shadow: ${(props) => props?.theme?.palette?.visual['brandMessageContentTitleShadow']?.textShadow ?? ''};
    font-weight: 400;
    font-size: 2.4em;
    margin: 0;
    @media (max-width: ${(props) => resolveThemeBreakPointValues(props?.theme, 'xl')}) {
